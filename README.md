...
- [Github Releases](https://github.com/siar1234/slean_note/releases/latest)
- [One Store](https://m.onestore.co.kr/v2/ko-kr/app/0000757738)
- [Google Play](https://play.google.com/store/apps/details?id=com.esa_go.note)

## Behind the Scenes

I made this app when I first started learning how to code.  
While updating it, I had to serve in the military in Korea. After returning, I started working on [Amphi Notes](https://github.com/amphi2024/notes).
